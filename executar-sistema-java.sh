...
echo "   🏠 Sistema Principal: http://localhost:8081/sistema"
echo "   🏠 Página Inicial:   http://localhost:8081/sistema"
echo "   📦 Coletas:          http://localhost:8081/sistema/coletas"
echo "   🗺️ Rotas:            http://localhost:8081/sistema/rotas"
echo "   👥 Usuários:         http://localhost:8081/sistema/usuarios"
echo "   ♻️ Materiais:        http://localhost:8081/sistema/materiais"
echo "   ��️ Mapa:             http://localhost:8081/sistema/mapa"
echo "   ⚙️ Configurações:    http://localhost:8081/sistema/configuracoes"
echo ""
echo "📚 Páginas Educativas:"
echo "   🎓 Inicial:          http://localhost:8081/educativo"
echo "   🟡 JSP:              http://localhost:8081/educativo/jsp"
echo "   🟢 JSF:              http://localhost:8081/educativo/jsf"
echo ""
echo "🔧 APIs REST:"
