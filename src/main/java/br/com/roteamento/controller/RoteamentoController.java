...
public class RoteamentoController {
    ...
    public ResponseEntity<Map<String, Object>> obterInformacoesRota(
            @Parameter(description = "Coordenadas de origem (lat,lng)", required = true, example = "-23.5505,-46.6333")
            @RequestParam("origem") String origem,
            @Parameter(description = "Coordenadas de destino (lat,lng)", required = true, example = "-23.5489,-46.6388")
